...
function adaptForNowPlaying()	
	SKIN:Bang('!SetOption LuaTopText Text "[#topText#0]"')
	SKIN:Bang('!SetOption LuaBottomText Text "[#bottomText#0]"')
	SKIN:Bang('!SetOption Time MeasureName "mPosition0"')
	SKIN:Bang('!SetOption Time MeasureName2 "mLength0"')
	SKIN:Bang('!SetOption Hairline MeasureName "mProgress0"')
	SKIN:Bang('!SetOption Progress MeasureName "mProgress0"')
	SKIN:Bang('!SetOption Play MeasureName "mStateButton0"')
...
function adaptForSpotify()
	SKIN:Bang('!SetOption LuaTopText Text "[#topText#1]"')
	SKIN:Bang('!SetOption LuaBottomText Text "[#bottomText#1]"')
	SKIN:Bang('!SetOption Time MeasureName "mPosition1"')
	SKIN:Bang('!SetOption Time MeasureName2 "mLength1"')
	SKIN:Bang('!SetOption Hairline MeasureName "mProgress1"')
	SKIN:Bang('!SetOption Progress MeasureName "mProgress1"')
	SKIN:Bang('!SetOption Play MeasureName "mStateButton1"')
